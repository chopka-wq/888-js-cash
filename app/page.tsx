...
export default function HomePage() {
  const jsonLd = {
    ...
    "@type": "Article",
    headline: "888Starz - Online Casino & Sports Betting Platform",
    description:
      "Join 888Starz for the ultimate online casino and sports betting experience with up to 500% welcome bonus.",
    author: {
      "@type": "Organization",
      name: "888Starz",
    },
    publisher: {
      ...
      logo: {
        "@type": "ImageObject",
        url: `${process.env.SITE_URL || "https://888starz.cash"}/logo.png`,
      },
    },
